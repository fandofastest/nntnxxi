...
public class ItemMovieActivity extends AppCompatActivity {
    ...
    private void getData(String url,int pageNum){
        ...
        final StringRequest stringRequest=new StringRequest(Request.Method.POST, fullUrl, new Response.Listener<String>() {
            @Override
        ...
        Volley.newRequestQueue(ItemMovieActivity.this).add(stringRequest);
